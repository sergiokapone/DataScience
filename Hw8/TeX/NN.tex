...
\begin{tikzpicture}
	...
	\node[above, align=center, text width=1cm, text=blue] at (first_layer_1.north) {$128$ neurons};

	\node[above, align=center, text width=1cm, text=orange] at (second_layer_1.north) {$256$ neurons};
	%	\foreach \i in {1,...,\nlf}{
